...
As long as this code executes the factory will return an instance of A when
...
Let's imagine that we have a large group of models and non model objects that
